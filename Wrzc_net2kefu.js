...
'&nbsp;<a style="text-decoration:none;" href="tencent://message/?uin=QQºÅ&Site=ÍøÕ¾Ãû³Æ&Menu=yes"><span style="text-decoration:underline;font-family:ËÎÌå;font-size:12px;color:#FF00FF;text-align:left">Éý¼¶×ÉÑ¯1</span>' + 
'</td>' + 
'</tr>' + 
'<tr>' + 
'<td align="left" width="10" height=20><img src="/images/kefu/8_online.gif"></td>' + 
'<td style="background-color: bgcolor; background-repeat: repeat; background-attachment: scroll; padding: 0; background-position: 0%" height="24" align="left">' + 
'&nbsp;<a style="text-decoration:none;" href="tencent://message/?uin=QQºÅ&Site=ÍøÕ¾Ãû³Æ2&Menu=yes"><span style="text-decoration:underline;font-family:ËÎÌå;font-size:12px;color:#FF00FF;text-align:left">Éý¼¶×ÉÑ¯2</span>' + 
'</td>' + 
'</tr>' + 
'<tr>' + 
'<td align="left" width="10" height=20><img src="/images/kefu/8_online.gif"></td>' + 
