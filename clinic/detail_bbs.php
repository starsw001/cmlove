...
<body onLoad="window.parent.document.getElementById('wrzc_netbbs').style.height = document.body.scrollHeight + 'px'">
<?php 
...
<form action="" method="post" name=wrzc_netform onsubmit="return chk()">
<div class="reply">
	<div class="rpy1">
