...
<div class=top_fav>
	<a
		onClick="this.style.behavior='url(#default#homepage)';this.setHomePage('<?php echo $Global['www_2domain']; ?>');"
	...
	<a href="<?php echo $Global['www_2domain']; ?>"
		...
		title='<?php echo $Global['m_sitename']; ?>' rel="sidebar">收藏</a><?php if (empty($cook_userid)){?> - <a
		href="<?php echo $Global['www_2domain']; ?>/login.php">登录</a><?php }?> - <a
		href="<?php echo $Global['www_2domain']; ?>/reg.php">注册</a>
	-
...
<div class=top_nav>
	...
	<div class=top_nav_right>
		<ul>
			...
			<li <?php echo $nav5; ?>>
				<a href="<?php echo $Global['www_2domain']; ?>/party">活动</a>
			</li>
			<li <?php echo $nav6; ?>>
...
<a
			href="<?php echo $Global['home_2domain']; ?>/<?php echo $cook_userid;?>"
			target=_blank class="uff0">“<?php echo $cook_nickname; ?>”</a>(<?php echo $cook_username; ?>)你好！　　　　<a
			href="<?php echo $Global['my_2domain']; ?>" class="nav">管理中心</a>
		<img
			src="<?php echo $Global['www_2domain']; ?>/images/top_login_cl.gif"
			align="absmiddle" />
		<a
			href="<?php echo $Global['my_2domain']; ?>/?b_gbook.php?submitok=list"
			class="nav">收件箱</a>
		<img
			src="<?php echo $Global['www_2domain']; ?>/images/top_login_cl.gif"
			align="absmiddle" />
		...
		<img
			src="<?php echo $Global['www_2domain']; ?>/images/top_login_cl.gif"
			align="absmiddle" />
		<a href="<?php echo $Global['my_2domain']; ?>/?c_photo_up.php"
			class="nav">上传照片</a>
		<img
			src="<?php echo $Global['www_2domain']; ?>/images/top_login_cl.gif"
			align="absmiddle" />
...
document.wrzc_netform.form_password.focus();return false;}}
		...
		<form action="<?php echo $Global['www_2domain']; ?>/login.php"
			method="post" name="wrzc_netform" onsubmit="return checkform()">
			<div class="top_login_c_rows">
				<div class="top_login_c_rows1">用户名：</div>
				<div class="top_login_c_rows2">
					<input name="form_username" value="wrzcnet" type="text"
						class=top_login_input />
				</div>
				...
				<div class="top_login_c_rows8">
					<a href="<?php echo $Global['www_2domain']; ?>/reg.php">
						<img src="../images/reg.gif" border="0" />
					</a>
				</div>
