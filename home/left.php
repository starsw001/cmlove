...
<ul>
	<div class="userphoto1"><?php if (empty($row['photo_s'])){?><img src=<?php echo $Global['www_2domain'];?>/images/nopic<?php echo $row['sex']; ?>.gif border=0 title="暂无照片"><?php } else {?><img src=<?php echo $Global['up_2domain'];?>/photo/<?php echo $row['photo_s']; ?> border=0 title="<?php echo $nickname.'的照片'; ?>"><?php }?></div>
