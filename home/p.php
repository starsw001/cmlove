...
<body>
<?php require_once wrzc_net.'home/head.php'?>
<div class="main">
<div class="left" style="width:140px;">
<?php require_once wrzc_net.'home/leftx.php'?>
<?php require_once wrzc_net.'home/left_ad.html'?>
</div>
<div class="right">
	<div class="rightTitle"><h4><?php echo $title; ?></h4><a href="myphoto<?php echo $uid; ?>.html">>>查看更多</a></div>
	<div class="rightContent ul2">
		<div class="pContent" style="padding:20px 0 0 0"><h2>照片标题：</h2><?php echo $title; ?>　　<h2>上传时间：</h2><?php echo $addtime; ?><a name="wrzc_net"></a></div>
		<div class="pContent">
			<div class="ps">
				<div class="psC">
					<div class="psL"><?php if ($maxfid == $fid){echo '';} else { ?><a href="<?php echo '1p'.$fid.'u'.$uid.'.html'; ?>#wrzc_net"><img src="images/prep.gif" border="0"/></a><?php }?></div>
					<div class="psM"></div>
					<div class="psR"><?php if ($minfid == $fid){echo '';} else { ?><a href="<?php echo '2p'.$fid.'u'.$uid.'.html'; ?>#wrzc_net"><img src="images/nextp.gif" border="0"/></a><?php }?></div>
					<div class="clear"></div>
				</div>
				<div class="psC" <?php if ($minfid != $fid){ ?> onClick="window.open('<?php echo '2p'.$fid.'u'.$uid.'.html'; ?>#wrzc_net','_self')"  style="cursor:pointer" title="点击查看下一张" <?php }?>><img src=<?php echo $Global['up_2domain'].'/photo/'.$path_b; ?> id=big /></div>
			</div>
		</div>
	</div>
<?php
...
<?php require_once wrzc_net.'home/foot.php'?>