...
function chkform(){
	if(document.www_wrzc_net_com.content.value==""){
	alert('请输入内容！');
	document.www_wrzc_net_com.content.focus();
	return false;
	}
	var str;
	str = document.www_wrzc_net_com.content.value;
	str=str.replace(/\n/ig,""); 
	...
	return false;}
		...
		<form action="dating<?php echo $fid.'.html'; ?>" method="post" name=www_wrzc_net_com onSubmit="return chkform()" >
		<?php if ($flag == 1) {?>
