...
<!-- 左侧 -->
	<div class="left">
		<div class="title">
			...
			function chk1(){
				if(document.wrzc_netform1.k.value==""){
				alert('请输入文章标题！');
				document.wrzc_netform1.k.focus();
				return false;
				}
			}
			function chk2(){
				if(document.wrzc_netform2.k.value==""){
				alert('请输入圈子名称！');
				document.wrzc_netform2.k.focus();
				return false;
				}
			}
			</script><form action="articlelist.php" method="get" name="wrzc_netform1" onsubmit="return chk1()"><input type="hidden" name="t" value="5" /><input name="k" type="text" class="Sinput" id="k" maxlength="50"><input type="image" src="../images/sox.gif" align=absmiddle /></form></div>
		</div>
		...
		<div class="title marginT15">
			...
			<div class="uTliPage"><form action="grouplist.php" method="get" name=wrzc_netform2 onsubmit="return chk2()"><input name="k" type="text" class="Sinput" id="k" maxlength="50"><input type="hidden" name="t" value="6" /><input type="image" src="../images/sox.gif" align=absmiddle /></form></div>
		</div>
		<div class="titleline"></div>
		<div class="clear"></div>
		<div class="C">
