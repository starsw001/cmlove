...
<!-- 右侧 -->
	<div class="right">
	  <div class="T margin5">
		...
		<div class="C Csearch">
			<div class="form">
			<form action="searchlist.php" method="get" name="wrzc_netform">
			<input type="hidden" name="t" value="1" /><input name="k" type="text" class="Sinput" maxlength="50" onClick="javascript:wrzc_netform.k.value=''" value="按用户名/昵称搜索"> <input type="image" src="../images/sox.gif" align=absmiddle />
			</form>
			</div>
