...
?>
	<div class="sexselect">
		<div class="wrzc_net1"><a href="<?php echo $sex2href; ?>"><img src="images/wrzc_net1.gif" title="显示更多女士" border="0" /></a>　<a href="<?php echo $sex1href; ?>"><img src="images/wrzc_net2.gif" title="显示更多男士" border="0" /></a></div>
		<div class="wrzc_net2">( 只显示有照片会员 )　<a href="<?php echo $Global['my_2domain'].'/?k_bidding.php'; ?>">我也要在这里显示</a></div>
	</div>
<?php
