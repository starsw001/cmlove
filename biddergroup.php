...
$jjpm_wrzc_net = 'groupwrzc_net'.$mainid;
if ($_COOKIE["$jjpm_wrzc_net"] != 'OK')$db->query("UPDATE ".__TBL_GROUP_MAIN__." SET qloveb=qloveb-$jjpmprice WHERE id=".$mainid);
setcookie("$jjpm_wrzc_net",'OK');
