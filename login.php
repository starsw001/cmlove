...
if ($submitok == "checkuser") {
	...
	if (! ereg ( "^[0-9]{1,9}$", $uid ) || $uid == 0)
		callmsg ( "Forbidden1!", "-1" );
	$password = trim ( $pwd );
	require_once wrzc_net . 'sub/conn.php';
...
<link href="css/main.css" rel="stylesheet" type="text/css">
	<style type="text/css">
.top_login .top_login_c .L,.top_login .top_login_c .R {
	float: left;
	height: 41px;
	line-height: 41px;
	color: #FFCCD9
...
.top_login .top_login_c .L {
	width: 320px;
	padding: 0 0 0 80px;
	text-align: left
}

.top_login .top_login_c .R {
	width: 497px;
	padding: 0 75px 0 0;
	text-align: right
}

.top_login .top_login_c .R a {
	text-decoration: underline;
	color: #ff0;
	font-weight: bold
}

.top_login .top_login_c .R a:hover {
	color: #cf0
}
...
.main2 .box .R .line1 .left,.main2 .box .R .line1 .center,.main2 .box .R .line1 .chkbox,.main2 .box .R .line1 .right
	{
	float: left;
	height: 30px
}

.main2 .box .R .line1 .left {
	width: 54px;
	line-height: 26px
}

.main2 .box .R .line1 .center {
	width: 168px
}

.main2 .box .R .line1 .right {
	width: 100px;
	line-height: 25px;
	padding: 0 0 0 5px
}

.main2 .box .R .line1 .chkbox {
	width: 15px;
	height: 28px;
	padding: 2px 0 0 0
}

.main2 .box .R .line2,.main2 .box .R .line3 {
	width: 436px;
	height: 30px;
...
alert('请输入登录用户名！');
document.wrzc_netform.form_username.focus();
return false;
}
...
alert('请输入密码！');
document.wrzc_netform.form_password.focus();
return false;
}}
function window_onload(){
	with (document.wrzc_netform){
		form_username.focus();
	}
}
</script>
<body>
<?php require_once wrzc_net.'topx.php';?>
<div class="top_login">
	...
	<div class="main2">
		<div class="box">
			<div class="L"></div>
			<form action="" method="post" name="wrzc_netform"
				...
				<div class="R">
					<div class="line1">
						...
						<div class="right" title="只有永久钻石会员才享有此功能">
					...
					<div class="line1">
						...
						<div class="right" title="点此找回密码，系统会自动把密码发送您注册时的邮箱">
							<a href="forgetpass.php" class="uDF2C91">忘记密码？</a>
						</div>
					</div>
					<div class="line1">
						<div class="left">
						...
						<div class="center">
							<input type="image" src="images/loginb.gif" />
						</div>
						<div class="right"></div>
					</div>
					<div class="line2">
						<img src="images/logintip.gif" />
						<a href="reg.php">
							<img src="images/regb.gif" border="0" />
						</a>
					</div>
