...
if ($submitok=="delupdate") {
	...
	if (file_exists(wrzc_net."up/".$Global['m_flvpath']."/".$path1))unlink(wrzc_net."up/".$Global['m_flvpath']."/".$path1);
	if (file_exists(wrzc_net."up/".$Global['m_flvpath']."/".$path2))unlink(wrzc_net."up/".$Global['m_flvpath']."/".$path2);
