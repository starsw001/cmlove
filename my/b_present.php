...
?>
<form action="b_present.php" method="post" name="wrzc_netform" onSubmit="return chkform()">
<script language="javascript">
function chkform(){
if(document.wrzc_netform.tmpkid.value==""){
alert('请先选择一个礼物？');
return false;}
...
return false;}
if(document.wrzc_netform.content.value.length<2 || document.wrzc_netform.content.value.length>200){
