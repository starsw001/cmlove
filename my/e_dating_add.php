...
<title>网软志成交友婚恋网-最专业的婚恋交友网站，网软志成将推出更多的交友，征婚，婚恋，婚介机构网站,交友网站源码,交友网站模板,征婚网站源码,征婚网站模板,婚恋网站模板,婚恋网站源码,交友，征婚，婚恋，婚介网站管理系统,做中国最好,易用,安全的网站系统,网络交友，征婚，婚恋，婚介网站管理系统源码正式版.
</title>
...
function chkform(){
	if(document.www_wrzc_net_com.title.value=="")	{
	alert('请输入约会主题！');
	document.www_wrzc_net_com.title.focus();
	return false;
	}
	var year8 = document.www_wrzc_net_com.year8.value;
	var month8 = document.www_wrzc_net_com.month8.value;
	var day8 = document.www_wrzc_net_com.day8.value;
	var hour8 = document.www_wrzc_net_com.hour8.value;
	var minute8 = document.www_wrzc_net_com.minute8.value;
	if(year8 == "")	{
	alert('请输入正确格式约会日期！');
	document.www_wrzc_net_com.year8.focus();
	return false;
	}
	if(month8 == ""){
	alert('请输入正确格式约会日期！');
	document.www_wrzc_net_com.month8.focus();
	return false;
	}
	if(day8 == "" )	{
	alert('请输入正确格式约会日期！');
	document.www_wrzc_net_com.day8.focus();
	return false;
	}
	if(hour8 == "")	{
	alert('请输入正确格式约会日期！');
	document.www_wrzc_net_com.hour8.focus();
	return false;
	}
	if(minute8 == "" )	{
	alert('请输入正确格式约会日期！');
	document.www_wrzc_net_com.minute8.focus();
	return false;
	}
	if(document.www_wrzc_net_com.contact.value=="")	{
	alert('请输入联系方式:！');
	document.www_wrzc_net_com.contact.focus();
	return false;
	}
	if(document.www_wrzc_net_com.content.value.length<10 || document.www_wrzc_net_com.content.value.length>1000){
...
switch (document.www_wrzc_net_com["province"].value) {
case "安徽" :
...
document.www_wrzc_net_com["city"].options.length = 0;    
for(var i = 0; i < cityOptions.length/2; i++) {
document.www_wrzc_net_com["city"].options[i]=new Option(cityOptions[i*2],cityOptions[i*2+1]);

if (document.www_wrzc_net_com["city"].options[i].value==city) 
{
//alert("here put City ok!");
document.www_wrzc_net_com["city"].selectedIndex = i;
}
}
}

function initprovcity(province,city) {
var provObject = document.www_wrzc_net_com["province"];
for(var i = 0; i < document.www_wrzc_net_com["province"].options.length; i++) {
if (document.www_wrzc_net_com["province"].options[i].value==province)
{
//alert("prov put is ok");
document.www_wrzc_net_com["province"].selectedIndex = i;
}
}
setcity(city);
}
      ...
      <script>initprovcity('广东','广州');</script></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left"><font color="#666666">
      <input name="year8" type="text" class="input" id="year8" style="width:40px;" onkeypress="if (event.keyCode &lt; 45 || event.keyCode &gt; 57) event.returnValue = false;" value="2010" size="4" maxlength="4" />
年
...
switch (document.www_wrzc_net_com["province2"].value) {
case "安徽" :
...
document.www_wrzc_net_com["city2"].options.length = 0;    
for(var i = 0; i < cityOptions2.length/2; i++) {
document.www_wrzc_net_com["city2"].options[i]=new Option(cityOptions2[i*2],cityOptions2[i*2+1]);

if (document.www_wrzc_net_com["city2"].options[i].value==city2) 
{
//alert("here put City ok!");
document.www_wrzc_net_com["city2"].selectedIndex = i;
}
}
}

function initprovcity2(province2,city2) {
var provObject2 = document.www_wrzc_net_com["province2"];
for(var i = 0; i < document.www_wrzc_net_com["province2"].options.length; i++) {
if (document.www_wrzc_net_com["province2"].options[i].value==province2)
{
//alert("prov put is ok");
document.www_wrzc_net_com["province2"].selectedIndex = i;
}
}
setcity2(city2);
}
      ...
      <script>initprovcity2('广东','广州');</script></td>
  </tr>
  <tr>
