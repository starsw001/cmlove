...
function chkform(){
if(document.wrzc_netFORM.a1.value==""){
alert('请选择“第一次约会你希望双方能做什么”！');
document.wrzc_netFORM.a1.focus();
return false;}
if(document.wrzc_netFORM.a2.value==""){
alert('请选择“约会中该谁买单”！');
document.wrzc_netFORM.a2.focus();
return false;}
if(document.wrzc_netFORM.a3.value.length>127 || document.wrzc_netFORM.a3.value.length<2){
alert('“你喜欢的约会场所”请控制在2~127个字内！');
document.wrzc_netFORM.a3.focus();
return false;}
if(document.wrzc_netFORM.a4.value.length>127 || document.wrzc_netFORM.a4.value.length<2){
alert('“你喜欢的音乐”请控制在2~127个字内！');
document.wrzc_netFORM.a4.focus();
return false;}
if(document.wrzc_netFORM.a5.value.length>127 || document.wrzc_netFORM.a5.value.length<2){
alert('“你常参与的体育活动”请控制在2~127个字内！');
document.wrzc_netFORM.a5.focus();
return false;}
if(document.wrzc_netFORM.a6.value.length>127 || document.wrzc_netFORM.a6.value.length<2){
alert('“你喜欢谈论”请控制在2~127个字内！');
document.wrzc_netFORM.a6.focus();
return false;}
if(document.wrzc_netFORM.a7.value.length>127 || document.wrzc_netFORM.a7.value.length<2){
alert('“你认为浪漫是”请控制在2~127个字内！');
document.wrzc_netFORM.a7.focus();
return false;}
}