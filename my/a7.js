...
function chkform(){
if(document.wrzc_netFORM.c1.value==""){
alert('请选择“你现在住在”');
document.wrzc_netFORM.c1.focus();
return false;}
if(document.wrzc_netFORM.c2.value==""){
alert('请选择“你认为自己性感吗”');
document.wrzc_netFORM.c2.focus();
return false;}
if(document.wrzc_netFORM.c3.value==""){
alert('请选择“你在性爱方面的经验”');
document.wrzc_netFORM.c3.focus();
return false;}
if(document.wrzc_netFORM.c4.value==""){
alert('请选择“你对待性爱的态度是”');
document.wrzc_netFORM.c4.focus();
return false;}
if(document.wrzc_netFORM.c5.value==""){
alert('请选择“你在性爱中乐于尝试吗”');
document.wrzc_netFORM.c5.focus();
return false;}
if(document.wrzc_netFORM.c6.value==""){
alert('请选择“你认为性和爱的关系是”');
document.wrzc_netFORM.c6.focus();
return false;}
if(document.wrzc_netFORM.c7.value==""){
alert('请选择“你认为性感主要体现在对方的”');
document.wrzc_netFORM.c7.focus();
return false;}
if(document.wrzc_netFORM.c8.value.length>127 || document.wrzc_netFORM.c8.value.length<2){
alert('“在性爱中，你往往是”请控制在2~127个字内');
document.wrzc_netFORM.c8.focus();
return false;}
if(document.wrzc_netFORM.c9.value.length>127 || document.wrzc_netFORM.c9.value.length<2){
alert('“你在寻找”请控制在2~127个字内');
document.wrzc_netFORM.c9.focus();
return false;}
if(document.wrzc_netFORM.c10.value.length>127 || document.wrzc_netFORM.c10.value.length<2){
alert('“什么比较能调动你的兴致”请控制在2~127个字内');
document.wrzc_netFORM.c10.focus();
return false;}
if(document.wrzc_netFORM.c11.value.length>127 || document.wrzc_netFORM.c11.value.length<2){
alert('“你能够接受(和你的伴侣)”请控制在2~127个字内');
document.wrzc_netFORM.c11.focus();
return false;}
}