...
function chkform(){
if(document.wrzc_netFORM.b1.value==""){
alert('请选择“你有子女吗”！');
document.wrzc_netFORM.b1.focus();
return false;}
if(document.wrzc_netFORM.b2.value==""){
alert('请选择“结婚后想要小孩吗”！');
document.wrzc_netFORM.b2.focus();
return false;}
if(document.wrzc_netFORM.b3.value==""){
alert('请选择“你愿意为爱情迁居别处吗”！');
document.wrzc_netFORM.b3.focus();
return false;}
if(document.wrzc_netFORM.b4.value==""){
alert('请选择“婚后你会承担多少家务”！');
document.wrzc_netFORM.b4.focus();
return false;}	
if(document.wrzc_netFORM.b5.value==""){
alert('请选择“喜欢旅游吗”！');
document.wrzc_netFORM.b5.focus();
return false;}
if(document.wrzc_netFORM.b6.value==""){
alert('请选择“婚恋中双方的关系应该是”！');
document.wrzc_netFORM.b6.focus();
return false;}
if(document.wrzc_netFORM.b7.value==""){
alert('请选择“你的婚恋态度”！');
document.wrzc_netFORM.b7.focus();
return false;}
if(document.wrzc_netFORM.b8.value==""){
alert('请选择“你的经济状况”！');
document.wrzc_netFORM.b8.focus();
return false;}	
if(document.wrzc_netFORM.b9.value==""){
alert('请选择“对方的家庭重要吗”！');
document.wrzc_netFORM.b9.focus();
return false;}
if(document.wrzc_netFORM.b10.value==""){
alert('请选择“你的消费观”！');
document.wrzc_netFORM.b10.focus();
return false;}
if(document.wrzc_netFORM.b11.value==""){
alert('请选择“你对现在工作的态度”！');
document.wrzc_netFORM.b11.focus();
return false;}
if(document.wrzc_netFORM.b12.value==""){
alert('请选择“你会打小孩吗”！');
document.wrzc_netFORM.b12.focus();
return false;}	
if(document.wrzc_netFORM.b13.value==""){
alert('请选择“家庭卫生”！');
document.wrzc_netFORM.b13.focus();
return false;}
if(document.wrzc_netFORM.b14.value==""){
alert('请选择“爱养宠物吗”！');
document.wrzc_netFORM.b14.focus();
return false;}
if(document.wrzc_netFORM.b15.value==""){
alert('请选择“异性密友”！');
document.wrzc_netFORM.b15.focus();
return false;}	
if(document.wrzc_netFORM.b16.value.length>127 || document.wrzc_netFORM.b16.value.length<2){
alert('“希望婚后的家庭关系”请控制在2~127个字内！');
document.wrzc_netFORM.b16.focus();
return false;}
if(document.wrzc_netFORM.b17.value.length>127 || document.wrzc_netFORM.b17.value.length<2){
alert('“觉得两人相处最重要的是”请控制在2~127个字内！');
document.wrzc_netFORM.b17.focus();
return false;}
if(document.wrzc_netFORM.b18.value.length>127 || document.wrzc_netFORM.b18.value.length<2){
alert('“你希望的结婚后的生活圈”请控制在2~127个字内！');
document.wrzc_netFORM.b18.focus();
return false;}
if(document.wrzc_netFORM.b19.value.length>127 || document.wrzc_netFORM.b19.value.length<2){
alert('“你最看重对方的？”请控制在2~127个字内！');
document.wrzc_netFORM.b19.focus();
return false;}	
}