...
function chkform(){
	if(document.wrzc_netFORM.weigh.value.length>12 || document.wrzc_netFORM.weigh.value.length<1){
	alert('请输入正确的体重');
	document.wrzc_netFORM.weigh.focus();
	return false;}
	if(document.wrzc_netFORM.tx.value==""){
	alert('请选择“体形”！');
	document.wrzc_netFORM.tx.focus();
	return false;
	}
	if(document.wrzc_netFORM.clothing.value==""){
	alert('请选择“着装”！');
	document.wrzc_netFORM.clothing.focus();
	return false;
	}
	if(document.wrzc_netFORM.star.value==""){
	alert('请选择“星座”！');
	document.wrzc_netFORM.star.focus();
	return false;
	}
	if(document.wrzc_netFORM.blood.value==""){
	alert('请选择“血型”！');
	document.wrzc_netFORM.blood.focus();
	return false;
	}

	if(document.wrzc_netFORM.zhongjiao.value==""){
	alert('请选择“宗教信仰”！');
	document.wrzc_netFORM.zhongjiao.focus();
	return false;
	}
<?php if ($row['ifhouse'] == 0 ){?>
	if(document.wrzc_netFORM.house.value==""){
	alert('请选择“住房”！');
	document.wrzc_netFORM.house.focus();
	return false;
	}
<?php }?>
<?php if ($row['ifcar'] == 0 ){?>
	if(document.wrzc_netFORM.car.value==""){
	alert('请选择“交通工具”！');
	document.wrzc_netFORM.car.focus();
	return false;
	}
<?php }?>
<?php if ($row['ifedu'] == 0 ){?>
	if(document.wrzc_netFORM.edu.value==""){
	alert('请选择“学历”！');
	document.wrzc_netFORM.edu.focus();
	return false;
	}
<?php }?>
<?php if ($row['ifedu'] == 0 ){?>
...
<?php }?>
	if(document.wrzc_netFORM.field.value==""){
	alert('请选择“工作行业”！');
	document.wrzc_netFORM.field.focus();
	return false;
	}
	if(document.wrzc_netFORM.job.value==""){
	alert('请选择“职业”！');
	document.wrzc_netFORM.job.focus();
	return false;
	}	
<?php if ($row['ifpay'] == 0 ){?>
	if(document.wrzc_netFORM.pay.value==""){
	alert('请选择“月收入”！');
	document.wrzc_netFORM.pay.focus();
	return false;
	}
<?php }?>
