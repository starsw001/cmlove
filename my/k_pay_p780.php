...
if ($submitok == 'addupdate'){
	...
	$c= "http://www.b780.com/1690543328/$a/$b";
?>
...
<table width="690" height="170" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <input name="kind" type="radio" id="kind7" value="6" /><label for="kind7">永久-钻石会员</label><input name="submitok" type="hidden" value="addupdate"></td>
        ...
        可通过<a target="blank" href="http://wpa.qq.com/msgrd?V=1&amp;Uin=0000&amp;Site=淘爱网&amp;Menu=yes"><img src="images/qq.gif" alt="点击发消息给客服QQ" border="0" /></a>QQ:0000或发短信至：0000 手机上。</span><br />
        <br />
        <br />
...
<script language="javascript" src="/ajax/wrzc_net2kefu.js"></script>
<div class="clear"></div>
