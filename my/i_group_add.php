...
<div class="main2_frame"><br />
  <table width="670" height="69" border="0" align="center" cellpadding="20" cellspacing="0" >
    <tr>
      <td bgcolor="#FDEEF8" style="line-height:200%;color:#DF2C91;">　　网软志成交友婚恋网开通兴趣圈子栏目，你可以按你的兴趣爱好创建一个圈子，邀请志同道合的朋友加入，在圈子里你们能够讨论共同关心的话题；分享图片、思想、文字、共同创业等。现在就来创建吧！<br />　　
  ...
  <table width="650" border="0" align="center" cellpadding="10" cellspacing="0" bgcolor="9EC9EC" >
    <form action="i_group_add.php" method="post" name="FORM" id="FORM">
      <tr bgcolor="#ECFAFF">
        ...
        <td width="466" bgcolor="#FFFFFF"><b>wrzcnet</b> (ID:121)　　[<a href="#" title=" ● 申请成功后，你可以设立三个副会长协同你管理圈子。" class="uDF2C91">帮助</a>]</td>
      </tr>
      <tr>
        ...
        <td width="466" bgcolor="#FFFFFF">
          <select name="qkind" id="qkind" style="font-size:9pt;">
            ...
            <option value=1,休闲/娱乐/吃喝>休闲/娱乐/吃喝</option><option value=2,数码相机技术>数码相机技术</option>          </select>
...
setcity(city);
      ...
      <tr bgcolor="#ECFAFF">
        ...
        <td width="466" height="13" bgcolor="#FFFFFF"><input type="submit" class="button" value=" 提 交 " ></td>
      </tr>
    </form>
  </table>
  <br />
