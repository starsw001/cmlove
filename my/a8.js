...
function chkform(){
if(document.wrzc_netFORM.d1.value.length>127 || document.wrzc_netFORM.d1.value.length<2){
alert('“以商会友目的”请控制在2~127个字内');
document.wrzc_netFORM.d1.focus();
return false;}
if(document.wrzc_netFORM.d2.value.length>50 || document.wrzc_netFORM.d2.value.length<2){
alert('“公司/机构名称”请控制在2~50个字内');
document.wrzc_netFORM.d2.focus();
return false;}
if(document.wrzc_netFORM.d3.value==""){
alert('请选择“职务分类”');
document.wrzc_netFORM.d3.focus();
return false;}
if(document.wrzc_netFORM.d4.value==""){
alert('请选择“职位等级”');
document.wrzc_netFORM.d4.focus();
return false;}
if(document.wrzc_netFORM.d5.value.length>50 || document.wrzc_netFORM.d5.value.length<2){
alert('“职务名称”请控制在2~50个字内');
document.wrzc_netFORM.d5.focus();
return false;}
if(document.wrzc_netFORM.d6.value==""){
alert('请选择“产业类别”');
document.wrzc_netFORM.d6.focus();
return false;}
if(document.wrzc_netFORM.d7.value.length>50 || document.wrzc_netFORM.d7.value.length<2){
alert('“学校科系”请控制在2~50个字内');
document.wrzc_netFORM.d7.focus();
return false;}
if(document.wrzc_netFORM.d8.value.length>50 || document.wrzc_netFORM.d8.value.length<2){
alert('“熟悉领域”请控制在2~50个字内');
document.wrzc_netFORM.d8.focus();
return false;}	
if(document.wrzc_netFORM.d9.value.length>50 || document.wrzc_netFORM.d9.value.length<2){
alert('“专长兴趣”请控制在2~50个字内');
document.wrzc_netFORM.d9.focus();
return false;}		
if(document.wrzc_netFORM.d10.value.length>50 || document.wrzc_netFORM.d10.value.length<2){
alert('“往来机构”请控制在2~50个字内');
document.wrzc_netFORM.d10.focus();
return false;}		
if(document.wrzc_netFORM.d11.value.length>2000 || document.wrzc_netFORM.d11.value.length<2){
alert('“工作经历”请控制在2~50个字内');
document.wrzc_netFORM.d11.focus();
return false;}	
}